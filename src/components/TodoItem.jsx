...
function TodoItem({ todo, todos, setTodos }) {
  ...
  const compTodoClass = mutableTodo.completed ? "text-lghtgrayblue dark:text-vdarkgrayblue line-through decoration-lghtgrayblue dark:decoration-vdarkgrayblue" : "text-vdgrayblue dark:text-lghtgrayblue";
  ...
  return (
    <li className={`bg-inherit w-[540px] h-[64px] py-[1.25em] px-[1.5em] flex border-b-[1px] border-vlghtgrayblue dark:border-vdarkgrayblue2 transition-transform`}>
      <input
        id={todo.id}
        type="checkbox"
      ...
      <div className="ml-auto cursor-pointer">
        {toggleItem ? <img src={cross} alt="crossIcon" onClick={handleCrossClick}/> : ""}
      </div>
    </li>
  );
}
